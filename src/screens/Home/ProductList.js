...
import { getProdcutCat,getProdcutList } from "../../lib/data";
...
function ProductList(props){
    ...
    React.useEffect(() => {
        ...
        if( data.prodCatApi == false){
            ...
            props.dispatch(getProdcutList({prod_id:props.route.params.prodCatId}));
            setData({
                ...data,
                prodCatApi: true,
            });
	...
	const renderProdCat = () => {
        let prod_cat_item =  props.data.productList;
